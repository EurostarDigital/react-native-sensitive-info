<!-- BEGIN EUROSTAR-ORG-INSTRUCTIONS (auto-generated by the org-agents-md-propagation skill — do not hand-edit this section; edits belong in org-instructions.md in agent-instruction-docs) -->
<!-- EUROSTAR-ORG-SOURCE: EurostarDigital/agent-instruction-docs@deployed/20260922-100206 (commit 53175deac956760789d55b4e8a40a3dfe2244825) -->
# Eurostar Digital Organisation Instructions
...
```
Co-authored-by: AGENT-NAME (MODEL-ID) <HUMAN-AUTHOR-EMAIL>
```
...
- Never use an admin/`--admin` merge, except where a named, org-approved
  automation skill (e.g. the AGENTS.md org-propagation skill) is explicitly
  authorised to do so for its own narrow, auditable change set.
...
<!-- END EUROSTAR-ORG-INSTRUCTIONS -->

<!-- BEGIN REPOSITORY-LEVEL-INSTRUCTIONS -->
<!-- BEGIN EUROSTAR-ORG-INSTRUCTIONS (auto-generated by the org-agents-md-propagation skill — do not hand-edit this section; edits belong in org-instructions.md in agent-instruction-docs) -->
<!-- EUROSTAR-ORG-SOURCE: EurostarDigital/agent-instruction-docs@deployed/20260922-073129 (commit cde98f06430b8f638fb89c2aeb5bdd5fc2c8f762) -->
This repository is part of the EurostarDigital engineering organisation and is
operated with AI agent assistance. Every agent working in this repository MUST
comply with the rules below. Human maintainers should treat these rules as the
baseline for any automated or AI-assisted contribution.
...
- Never fabricate tool output, test results, or data. If something could not be
  obtained or executed, say so and explain why.
- Cite sources where possible; if you cannot, say so explicitly.
<!-- END REPOSITORY-LEVEL-INSTRUCTIONS -->
<!-- END REPOSITORY-LEVEL-INSTRUCTIONS -->
